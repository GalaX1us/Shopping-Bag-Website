...
{ ?>
  ...
  <form method="post" action="index.php?action=CreerCompte"> 
        ...
        <div class="mb-3">
          ...
          <input type="text" name="code" placeholder="code postal" class="form-control" aria-required="true" required>
        </div>
        <br>
        <div class="mb-3">
          <input type="tel" name="phone" placeholder="Numéro de téléphone" class="form-control"  aria-describedby="emailHelp" aria-required="true" required>
